...
function SideBar() {
  ...
  return (
    <aside className='h-screen flex flex-col shrink-0 w-full lg:w-[200px] transition-all bg-[#f8f9fb] duration-300 ease-in-out m-0 left-0 px-2'>
      <div className='grow'>
        <div className='pt-4 px-6 w-full lg:block lg:w-auto mt-2' >
          <a href='/'>
      ...
      <div >
        <Link onClick={() => {
          ...
          <MdOutlineLogout size={23} /> Logout
        </Link>
      </div>
