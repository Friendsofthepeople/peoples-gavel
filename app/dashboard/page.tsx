      ...
      <div className="flex items-start">
        ...
        <div className="flex-end w-full">
          <div className="pt-[60px] lg:pt-[75px] px-2">
            ...
            {activeView == "issues" || activeView == "issues" ? (
              <Issues />
            ) : activeView == "law" ? (
              <Law />
            ) : activeView == "profile" ? (
              ...
              <>
                <div>
                  <p className="p-2 text-[22px] text-semibold">
                    Current Issues
                  </p>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div className="bg-[#f8f9fb] rounded-xl p-2 ">
                      ...
                      <div className="bg-white rounded-xl p-2">
                        <p className="text-[16px] text-semibold">
                          NA/2024/001:Education Reform Bill
                        </p>
                        <p className="text-[#a7a7ae] text-[14px]">
                          This bill seeks to overhaul the current educational
                          system by introducing new curricula and teaching
                          methods aimed at enhancing students{"'"} critical
                          thinking
                        </p>
                    ...
                    <div className="bg-[#f8f9fb] rounded-xl p-2 ">
                      ...
                      <div className="bg-white rounded-xl p-2">
                        <p className="text-[16px] text-semibold">
                          SB/2024/005:Heathcare improvement Bill
                        </p>
                        <p className="text-[#a7a7ae] text-[14px]">
                          This bill seeks to overhaul the current educational
                          system by introducing new curricula and teaching
                    ...
                    <div className="bg-[#f8f9fb] rounded-xl p-2 ">
                      ...
                      <div className="bg-white rounded-xl p-2">
                        <p className="text-[16px] text-semibold">
                          CA/2024/0012:Nairobi urban planning and zoning Bill
                        </p>
                        <p className="text-[#a7a7ae] text-[14px]">
                          This bill seeks to overhaul the current educational
                          system by introducing new curricula and teaching
