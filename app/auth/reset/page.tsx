  ...
  return (
    <main className='p-6 lg:p-0 grid grid-col-1 md:grid-cols-2 items-center max-h-screen lg:h-screen'>
      <div className='relative w-full h-[350px] md:min-h-[70%] lg:min-h-[100%] lg:mt-4'>
        <Image
          src={"/assets/images/ahmed-galal-LaLJXbAloZE-unsplash.jpg"}
          alt="presentation"
          layout="fill"
          objectFit="cover"
          placeholder='blur'
      ...
      <div className='lg:pl-16 lg:max-w-[70%] pb-6 lg:pb-0'>
       ...
       <div className='flex flex-col my-4'>
        ...
        <div className='flex flex-col my-4'>
          ...
          <input className="py-2 px-2  rounded-xl" placeholder='confirm your password' type="text"></input>
        </div>

        <div >
          <input type="submit" className='border-2 border-[#01C909] text-[#ffffff] bg-[#01C909] rounded-xl py-2 px-4 my-2 w-full' value="Proceed to Login"></input>
        </div>
